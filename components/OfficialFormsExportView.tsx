...
export default function OfficialFormsExportView() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-[#23304a] bg-[#131b2e] p-4 sm:p-5 shadow-sm no-print">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0d1524] border border-[#23304a] text-sky-400 shadow-sm">
              <FileText className="h-5 w-5" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span className="font-mono text-[10px] text-sky-400 uppercase tracking-widest bg-[#0d1524] border border-sky-800/60 px-1.5 py-0.5 rounded font-semibold">
                  DOC-SYS-04
                </span>
          ...
          <div className="flex items-center gap-2 font-mono text-xs w-full sm:w-auto justify-end">
            <button
              onClick={handlePrint}
              className="flex items-center gap-1.5 bg-[#0d1524] hover:bg-[#162238] text-slate-200 px-3.5 py-2 rounded-lg transition-all border border-[#23304a] shadow-xs hover:border-sky-500/50 active:scale-95 cursor-pointer font-mono"
            >
        ...
        <div className="mt-4 flex items-center gap-1.5 border-t border-[#23304a] pt-3 text-xs font-mono flex-wrap">
          <button
            ...
            className={`px-3.5 py-1.5 rounded-lg border transition-all cursor-pointer font-mono text-xs flex items-center gap-2 ${
              activeFormType === 'rf_fr_004'
                ...
                : 'bg-[#0d1524] border-[#23304a] text-slate-400 hover:text-slate-200 hover:bg-[#162238] hover:border-slate-600'
            }`}
          >
        ...
        {activeFormType === 'rf_fr_004' && (
          <div className="mt-3 pt-3 border-t border-[#23304a] flex flex-wrap items-center justify-between gap-3 text-xs font-mono">
            <div className="flex items-center gap-2.5 flex-wrap">
              ...
              <div className="flex items-center bg-[#0d1524] border border-[#23304a] rounded-lg overflow-hidden shadow-xs">
                <button
                  type="button"
                  onClick={() => handleStepDay(-1)}
                  className="px-2.5 py-1 text-slate-400 hover:text-sky-400 hover:bg-[#162238] transition-colors border-r border-[#23304a] cursor-pointer"
                ...
                >
                  {availableShiftDates.map(d => (
                    <option key={d} value={d} className="bg-[#131b2e] text-slate-200">
                      {d} {d === getRealtimeShiftDate() ? '(Today · Live)' : '(Past Sheet)'}
                    </option>
                  ))}
                  {!availableShiftDates.includes(selectedShiftDate) && (
                    <option value={selectedShiftDate} className="bg-[#131b2e] text-slate-200">
                ...
                <button
                  type="button"
                  onClick={() => handleStepDay(1)}
                  className="px-2.5 py-1 text-slate-400 hover:text-sky-400 hover:bg-[#162238] transition-colors border-l border-[#23304a] cursor-pointer"
              ...
              <div className="flex items-center gap-1.5 text-slate-400">
                ...
                <input
                  ...
                  className="bg-[#0d1524] border border-[#23304a] text-slate-200 rounded-lg px-2 py-0.5 text-xs font-mono focus:border-sky-500 focus:outline-none cursor-pointer shadow-xs"
                />
              </div>
              ...
              {selectedShiftDate !== getRealtimeShiftDate() && (
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-[#0d1524] hover:bg-[#162238] text-sky-400 border border-sky-800/60 text-[11px] font-mono transition-all cursor-pointer shadow-xs active:scale-95 font-semibold"
                >
                  Jump to Today (Live)
                </button>
              )}
            ...
            <div className="flex items-center gap-2 text-xs">
              ...
              {sheet.shift_date === getRealtimeShiftDate() ? (
                ...
                <span className="px-2 py-0.5 rounded bg-[#0d1524] text-slate-400 border border-[#23304a] text-[10px] font-mono">
                  ARCHIVED LOG
                </span>
              )}
          ...
          <div className="mt-3 pt-3 border-t border-[#23304a] flex flex-wrap items-center justify-between gap-3 text-xs font-mono">
            <div className="flex items-center gap-2.5 flex-wrap">
              ...
              <select
                ...
                className="bg-[#0d1524] border border-[#23304a] text-slate-200 rounded-lg px-3 py-1.5 focus:border-sky-500 focus:outline-none max-w-sm md:max-w-md shadow-xs text-xs font-mono"
              >
                {reports.map(r => (
                  <option key={r.id} value={r.id} className="bg-[#131b2e] text-slate-200">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 bg-[#0d1524] hover:bg-[#162238] text-sky-400 px-3.5 py-1.5 rounded-lg border border-[#23304a] hover:border-sky-500/50 shadow-xs transition-all active:scale-95 cursor-pointer font-mono text-xs font-medium"
              >
        ...
        {activeFormType === 'audit' && (
          <div className="mt-3 pt-3 border-t border-[#23304a] flex flex-wrap items-center justify-between gap-3 text-xs font-mono">
            <div className="flex items-center gap-2.5 flex-wrap">
              ...
              <div className="flex items-center bg-[#0d1524] border border-[#23304a] rounded-lg overflow-hidden shadow-xs">
                ...
                <select
                  ...
                  className="bg-transparent text-slate-200 px-2.5 py-1 text-xs font-mono focus:outline-none cursor-pointer"
                >
                  <option value="all" className="bg-[#131b2e] text-slate-200">
                  ...
                  {auditDateFilter !== 'all' && !availableAuditDates.includes(auditDateFilter) && (
                    <option value={auditDateFilter} className="bg-[#131b2e] text-slate-200">
              ...
              {auditDateFilter !== 'all' && (
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-[#0d1524] hover:bg-[#162238] text-slate-300 border border-[#23304a] text-[11px] font-mono transition-all cursor-pointer shadow-xs"
                >
                  All Dates
                </button>
              )}
              ...
              {auditDateFilter !== getRealtimeShiftDate() && (
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-[#0d1524] hover:bg-[#162238] text-sky-400 border border-sky-800/60 text-[11px] font-mono transition-all cursor-pointer shadow-xs font-semibold"
                >
                  Today&apos;s Logs
                </button>
              )}
            ...
            <div className="flex items-center gap-2 flex-wrap">
              {/* Table Name Filter */}
              <div className="flex items-center gap-1 bg-[#0d1524] border border-[#23304a] rounded-lg px-2 py-1 shadow-xs">
                ...
                >
                  <option value="all" className="bg-[#131b2e] text-slate-200">All Tables</option>
                  {availableAuditTables.map(t => (
                    <option key={t} value={t} className="bg-[#131b2e] text-slate-200">{t}</option>
                  ))}
                </select>
              </div>
              ...
              <div className="flex items-center gap-1 bg-[#0d1524] border border-[#23304a] rounded-lg px-2 py-1 shadow-xs">
                <select
                  ...
                  className="bg-transparent text-slate-200 text-xs font-mono focus:outline-none cursor-pointer"
                >
                  <option value="all" className="bg-[#131b2e] text-slate-200">All Actions</option>
                  <option value="insert" className="bg-[#131b2e] text-emerald-400 font-semibold">INSERT</option>
                  <option value="update" className="bg-[#131b2e] text-amber-400 font-semibold">UPDATE</option>
                  <option value="void" className="bg-[#131b2e] text-rose-400 font-semibold">VOID / DELETE</option>
                </select>
              </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="bg-[#0d1524] border border-[#23304a] text-slate-200 rounded-lg pl-8 pr-3 py-1 text-xs font-mono focus:border-sky-500 focus:outline-none w-44 placeholder-slate-500 shadow-xs"
                />
              </div>
              ...
              {/* Records count badge */}
              <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-[#0d1524] border border-[#23304a] text-sky-400 font-mono font-bold text-[11px]">
      ...
      {activeFormType === 'audit' && (
        <div className="rounded-lg border border-[#23304a] bg-[#131b2e] p-4 sm:p-5 shadow-sm space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#23304a] pb-3">
            <div className="flex items-center gap-2.5 text-slate-100 font-semibold">
              <div className="p-2 rounded-lg bg-[#0d1524] border border-[#23304a] text-sky-400 shadow-xs">
            ...
            <div className="flex items-center gap-2 font-mono text-xs">
              <button
                ...
                className="flex items-center gap-1.5 bg-[#0d1524] hover:bg-[#162238] text-sky-400 px-3 py-1.5 rounded-lg border border-[#23304a] hover:border-sky-500/50 transition-all cursor-pointer text-xs active:scale-95 shadow-xs"
              ...
              <span className="text-xs font-mono text-sky-400 bg-[#0d1524] border border-[#23304a] px-3 py-1.5 rounded-lg font-semibold">
          ...
          {(auditDateFilter !== 'all' || auditTableFilter !== 'all' || auditActionFilter !== 'all' || auditSearchQuery.trim()) && (
            <div className="flex items-center gap-2 flex-wrap text-xs font-mono pt-1 pb-1">
              ...
              {auditDateFilter !== 'all' && (
                <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded bg-[#0d1524] text-sky-400 border border-sky-800/60 text-[11px] font-medium">
          ...
          {filteredAuditLogs.length === 0 ? (
            <div className="rounded-lg border border-dashed border-[#23304a] bg-[#0d1524]/50 p-10 text-center space-y-3 font-mono">
              <div className="h-10 w-10 mx-auto rounded-lg bg-[#0d1524] border border-[#23304a] flex items-center justify-center text-sky-400 shadow-xs">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#0d1524] hover:bg-[#162238] text-sky-400 border border-[#23304a] text-xs font-mono transition-colors cursor-pointer shadow-xs"
              >
                <RotateCcw className="h-3 w-3" />
            ...
            <div className="rounded-lg border border-[#23304a] bg-[#0d1524] overflow-hidden shadow-xs">
              <table className="w-full text-left text-xs font-mono">
                <thead className="bg-[#090e17] text-slate-400 text-[10px] tracking-wider uppercase border-b border-[#23304a]">
                  <tr>
                ...
                <tbody className="divide-y divide-[#1b263b]">
                  {filteredAuditLogs.map(log => (
                    <tr key={log.id} className="hover:bg-[#131b2e] transition-colors">
                      ...
                      <td className="py-2.5 px-3 font-semibold whitespace-nowrap">
                        <span className="px-1.5 py-0.5 rounded bg-[#131b2e] border border-[#23304a] text-sky-400 text-[10px] tracking-wide font-mono font-medium">
                          {log.table_name}
                        </span>
                      </td>
                      ...
                      <td className="py-2.5 px-3 text-right whitespace-nowrap">
                        <button
                          ...
                          className="inline-flex items-center gap-1 px-2.5 py-1 rounded bg-[#131b2e] hover:bg-[#1b263b] text-sky-400 border border-[#23304a] text-[10px] transition-colors cursor-pointer active:scale-95 font-mono shadow-xs"
                        >
          ...
          {expandedLogId != null && (() => {
            ...
            return (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm p-4 no-print">
                <div className="w-full max-w-2xl rounded-lg border border-[#23304a] bg-[#131b2e] p-5 shadow-2xl space-y-4 max-h-[90vh] flex flex-col font-mono text-xs">
                  <div className="flex items-center justify-between border-b border-[#23304a] pb-3">
                    ...
                    <button
                      ...
                      className="text-slate-400 hover:text-slate-200 p-1 rounded-lg hover:bg-[#162238] transition-colors cursor-pointer"
                    >
                      <X className="h-4 w-4" />
                    </button>
                  </div>

                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 bg-[#0d1524] p-3 rounded-lg border border-[#23304a] text-[11px]">
                    <div>
                  ...
                  <div className="overflow-y-auto space-y-3 flex-1 pr-1">
                    {expLog.new_row && (
                      <div>
                        ...
                        <pre className="bg-[#090e17] p-3 rounded-lg border border-[#23304a] text-[11px] text-slate-300 overflow-x-auto whitespace-pre-wrap">
                  ...
                  <div className="flex items-center justify-end pt-3 border-t border-[#23304a]">
                    <button
                      type="button"
                      onClick={() => setExpandedLogId(null)}
            ...
            <form onSubmit={handleSaveCertificateRemarks} className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-2.5">
                  <label className={`flex items-start gap-2.5 p-2.5 rounded-lg border transition-all cursor-pointer select-none ${
                    editFlushing 
                      ...
                      : 'bg-[#0d1524] border-[#23304a] text-slate-400 hover:border-slate-600'
                  }`}>
                    <input
                      type="checkbox"
                      checked={editFlushing}
                      onChange={e => setEditFlushing(e.target.checked)}
                      className="mt-0.5 h-4 w-4 rounded border-[#23304a] bg-[#131b2e] text-amber-500 focus:ring-amber-500 cursor-pointer"
                    />
                  ...
                  <label className={`flex items-start gap-2.5 p-2.5 rounded-lg border transition-all cursor-pointer select-none ${
                    ...
                    <input
                      ...
                      className="mt-0.5 h-4 w-4 rounded border-[#23304a] bg-[#131b2e] text-sky-500 focus:ring-sky-500 cursor-pointer"
                    />
                    <div className="font-mono text-xs">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#0d1524] border border-[#23304a] rounded-lg px-3 py-2 text-xs font-mono text-slate-200 placeholder-slate-500 focus:outline-none focus:border-sky-500 resize-y shadow-xs"
                />
              </div>

              <div className="flex items-center justify-end gap-2 pt-2 border-t border-[#23304a] font-mono">
                <button
                  type="button"
                  onClick={() => setIsEditingRemarks(false)}
                  className="px-4 py-2 rounded-lg text-xs text-slate-400 hover:bg-[#162238] transition-colors cursor-pointer border border-[#23304a]"
                >
                  Cancel
                </button>
                <button
