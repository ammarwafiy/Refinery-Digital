    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-[#23304a] bg-[#131b2e] p-4 sm:p-5 shadow-sm">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-[#23304a] pb-4">
          ...
          {/* Sub-Tabs Actions */}
          <div className="flex items-center gap-2 bg-[#090e17] p-1 rounded-lg border border-[#23304a]">
            <button
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-mono font-medium transition-colors cursor-pointer ${
                activeSubTab === 'new'
                  ? 'bg-sky-600 text-white shadow-xs border border-sky-500'
                  : 'text-slate-400 hover:text-slate-200'
              }`}
          ...
          <div className="mt-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
            <div className="relative w-full sm:w-80">
              ...
              <input
                ...
                className="w-full bg-[#0d1524] border border-[#23304a] rounded pl-8 pr-3 py-1.5 text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500/30 font-mono"
              />
            </div>
            ...
            <div className="flex items-center gap-1.5 self-start sm:self-auto font-mono text-xs">
              ...
              {[
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded text-[11px] border font-mono transition-colors cursor-pointer ${
                    filterStatus === f.id
                      ? 'bg-sky-600 border-sky-500 text-white font-medium shadow-xs'
                      : 'border-[#23304a] bg-[#0d1524] text-slate-400 hover:text-slate-200 hover:border-slate-600'
                  }`}
                >
                  {f.label}
                </button>
      ...
      {activeSubTab === 'new' && (
        <div className="rounded-lg border border-[#23304a] bg-[#131b2e] p-5 sm:p-6 shadow-sm">
          <h2 className="text-sm font-bold text-slate-100 mb-4 border-b border-[#23304a] pb-3 font-mono uppercase tracking-wider">
          ...
          <form onSubmit={handleCreateSample} className="space-y-5">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className="text-[11px] font-mono text-slate-300 uppercase tracking-wider">Lot Number *</label>
                  <span className="inline-flex items-center gap-1 text-[10px] font-mono text-sky-400 bg-[#0d1524] px-1.5 py-0.2 rounded border border-[#23304a]">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-[#0d1524] border border-[#23304a] rounded pl-3 pr-20 py-1.5 text-xs font-mono text-slate-100 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500/30"
                  />
                  <button
                    type="button"
                    onClick={() => setNewLotNo(generateNextLotNo(newProductId, newDate, newProductOther))}
                    className="absolute right-1 top-1 bottom-1 px-2.5 rounded bg-[#131b2e] hover:bg-[#182238] text-sky-400 hover:text-white text-[10px] font-mono transition-colors flex items-center gap-1 border border-[#23304a] cursor-pointer"
              ...
              <div>
                <label className="block text-[11px] font-mono text-slate-300 mb-1 uppercase tracking-wider">Sample Date</label>
                <input
                  type="date"
                  value={newDate}
                  onChange={e => setNewDate(e.target.value)}
                  className="w-full bg-[#0d1524] border border-[#23304a] rounded px-3 py-1.5 text-xs font-mono text-slate-100 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500/30 cursor-pointer"
                />
              </div>

              <div>
                <label className="block text-[11px] font-mono text-slate-300 mb-1 uppercase tracking-wider">Time Check</label>
                <input
                  type="time"
                  value={newTimeCheck}
            ...
            <div className="rounded border border-[#23304a] bg-[#0d1524] p-4">
              ...
              <select
                ...
                className="w-full bg-[#131b2e] border border-[#23304a] rounded px-3 py-2 text-xs text-slate-100 font-mono font-medium focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500/30 cursor-pointer"
              >
                {products.map(p => (
                ...
                <option value="others" className="bg-[#0c121e] text-slate-100">Others — Free Text Entry</option>
              </select>

              {newProductId === 'others' && (
                <div className="mt-3">
                  <label className="block text-[11px] font-mono text-slate-300 mb-1">Enter Custom Product Name:</label>
                  <input
                    type="text"
                    required
                    ...
                    className="w-full bg-[#131b2e] border border-[#23304a] rounded px-3 py-1.5 text-xs text-slate-100 font-mono focus:outline-none focus:border-sky-500"
                  />
                </div>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                <label className="block text-[11px] font-mono text-slate-300 mb-1">Feed Tank</label>
                <select
                  value={newFeedTankId}
                  onChange={e => setNewFeedTankId(e.target.value)}
                  className="w-full bg-[#0d1524] border border-[#23304a] rounded px-3 py-1.5 text-xs font-mono text-slate-100 cursor-pointer focus:outline-none focus:border-sky-500"
                >
                  {tanks.filter(t => t.kind === 'feed' || t.kind === 'both').map(t => (
                    <option key={t.id} value={t.id} className="bg-[#0c121e] text-slate-100">{t.code}</option>
                  ))}
                </select>
              </div>

              <div>
                <label className="block text-[11px] font-mono text-slate-300 mb-1">Discharge Tank</label>
                <select
              ...
              <div>
                <label className="block text-[11px] font-mono text-slate-300 mb-1">Crystallizer / Batch No</label>
                <input
                  type="text"
                  placeholder="CR-04 / B260904"
                  value={newBatchNo}
                  onChange={e => setNewBatchNo(e.target.value)}
                  className="w-full bg-[#0d1524] border border-[#23304a] rounded px-3 py-1.5 text-xs font-mono text-slate-100 focus:outline-none focus:border-sky-500"
                />
              </div>

              <div>
                <label className="block text-[11px] font-mono text-slate-300 mb-1">Sampling Point</label>
                <select
                ...
                >
                  {samplingPoints.map(sp => (
                    <option key={sp.id} value={sp.id} className="bg-[#0c121e] text-slate-100">{sp.name}</option>
                  ))}
                </select>
              </div>
            </div>
              ...
              <div className="flex flex-wrap items-center gap-6 text-xs text-slate-300 font-mono">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="h-4 w-4 rounded border-[#23304a] bg-[#131b2e] text-sky-600 focus:ring-sky-500 cursor-pointer"
                  />
                  <span>Flushing</span>
                </label>
            ...
            <div className="rounded border border-[#23304a] bg-[#0d1524] p-4">
                  ...
                  return (
                    <label
                      ...
                      className={`flex items-center gap-2 p-2 rounded border cursor-pointer transition-colors ${
                        isChecked 
                          ? 'border-sky-500 bg-[#162238] text-white font-medium shadow-xs' 
                          : 'border-[#23304a] bg-[#131b2e] text-slate-300 hover:border-slate-600'
                      }`}
                    >
                      <input
                        type="checkbox"
                        checked={isChecked}
                        readOnly
                        className="h-3.5 w-3.5 rounded border-[#23304a] bg-[#0d1524] text-sky-600 focus:ring-sky-500 pointer-events-none"
                      />
              ...
              <div className="mt-4 pt-3 border-t border-[#23304a]">
                <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <label htmlFor="new-temp-master" className="text-xs font-medium text-slate-200 font-mono cursor-pointer flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-mono px-1.5 py-0.2 rounded bg-[#131b2e] text-sky-400 border border-[#23304a]">
                  ...
                  <div className="flex items-center gap-1.5">
                    <button
                      ...
                      className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#131b2e] hover:bg-[#182238] text-slate-300 hover:text-white border border-[#23304a] transition-colors cursor-pointer"
                    >
                      Select All 9
                    </button>
                    <button
                      ...
                      className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#131b2e] hover:bg-[#182238] text-slate-400 border border-[#23304a] transition-colors cursor-pointer"
                    >
                      Deselect All
                    </button>
                  </div>
                  ...
                  {[10, 15, 20, 25, 30, 35, 40, 45, 50].map(temp => {
                    ...
                    return (
                      <label
                        ...
                        className={`flex items-center justify-center gap-1.5 py-1.5 px-2 rounded border text-xs font-mono cursor-pointer transition-colors ${
                          isTicked
                            ? 'border-sky-500 bg-[#162238] text-white font-medium shadow-xs'
                            : 'border-[#23304a] bg-[#131b2e] text-slate-400 hover:border-slate-600 hover:text-slate-200'
                        }`}
                      >
                        <input
                          type="checkbox"
                          checked={isTicked}
                          readOnly
                          className="h-3 w-3 rounded border-[#23304a] bg-[#0d1524] text-sky-600 focus:ring-sky-500 pointer-events-none"
                        />
            ...
            <div className="flex items-center justify-end gap-2.5 pt-3 border-t border-[#23304a]">
              <button
                type="button"
                onClick={() => setActiveSubTab('list')}
              ...
              <button
                type="submit"
                className="flex items-center gap-2 bg-sky-600 hover:bg-sky-700 text-white font-mono font-medium text-xs uppercase px-5 py-2 rounded transition-colors border border-sky-500 cursor-pointer"
              >
      ...
      {activeSubTab !== 'new' && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 rounded-lg border border-[#23304a] bg-[#131b2e] p-3.5 shadow-sm space-y-2.5 max-h-[850px] overflow-y-auto">
            <div className="flex items-center justify-between pb-2 border-b border-[#23304a] text-[11px] font-mono text-slate-400">
              <span className="uppercase tracking-wider font-semibold">REFINERY SAMPLES</span>
              <span className="bg-[#0d1524] text-sky-400 px-2 py-0.5 rounded font-medium border border-[#23304a]">{filteredReports.length} in queue</span>
            </div>
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-3 rounded border transition-colors cursor-pointer ${
                    isSelected
                      ? 'border-sky-500 bg-[#162238] shadow-xs'
                      : 'border-[#23304a] bg-[#0d1524] hover:bg-[#131b2e] hover:border-slate-600'
                  }`}
                >
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      ...
                      <div className="text-[11px] text-slate-300 mt-0.5 font-medium flex items-center gap-1.5 font-mono">
                        ...
                        {rep.remarks?.includes('Process Log') && (
                          <span className="text-[8px] font-mono px-1 py-0.2 rounded border border-[#23304a] bg-[#131b2e] text-sky-400">
                            AUTO
                          </span>
                        )}
                      </div>
                    ...
                    <div>
                      {isRejected ? (
                        <span className="text-[9px] font-mono text-red-400 bg-red-950/40 px-1.5 py-0.5 rounded border border-red-800/60 font-semibold">
                          REJECT
                        </span>
                      ) : isAccepted ? (
                        <span className="text-[9px] font-mono text-emerald-400 bg-emerald-950/40 px-1.5 py-0.5 rounded border border-emerald-800/60 font-semibold">
                          ACCEPT
                        </span>
                      ) : isConcession ? (
                        <span className="text-[9px] font-mono text-amber-400 bg-amber-950/40 px-1.5 py-0.5 rounded border border-amber-800/60 font-semibold">
                          CONCESSION
                        </span>
                      ) : (
                        <span className="text-[9px] font-mono text-sky-400 bg-sky-950/40 px-1.5 py-0.5 rounded border border-sky-800/60">
                          AWAITING
                        </span>
                      )}
                    </div>
                  ...
                  <div className="mt-2 flex items-center justify-between text-[10px] font-mono text-slate-500 border-t border-[#1b263b] pt-1.5">
          ...
          <div className="lg:col-span-8 space-y-6">
            {selectedReport ? (
              <div className="rounded-lg border border-[#23304a] bg-[#131b2e] p-5 sm:p-6 shadow-sm space-y-5">
                {/* Sample Header Summary */}
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-[#23304a] pb-4">
                  <div>
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="text-[10px] font-mono px-2 py-0.5 rounded border border-[#23304a] bg-[#0d1524] text-sky-400 font-medium">
                      ...
                      {selectedReport.remarks?.includes('Process Log') && (
                        <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#0d1524] text-sky-400 border border-[#23304a] flex items-center gap-1 font-medium">
                    ...
                    <div className="mt-1 text-xs text-slate-400 font-mono flex flex-wrap items-center gap-2.5">
                      ...
                      <span>•</span>
                      <span>Tanks: <strong className="text-slate-300">{selectedReport.feed_tank_code || 'Feed'} → {selectedReport.discharge_tank_code || 'Discharge'}</strong></span>
                      <span>•</span>
                      <span>Submitted: <strong className="text-slate-300">{selectedReport.submitted_by_name}</strong></span>
                    </div>
                  </div>
                    ...
                    {selectedReport.decision ? (
                      <>
                        ...
                        {(role === 'qc_analyst' || role === 'qc_manager' || role === 'admin') && (
                          <button
                            ...
                            className="flex items-center gap-1.5 bg-[#0d1524] hover:bg-[#182238] text-slate-300 hover:text-white border border-[#23304a] px-2.5 py-1.5 rounded text-xs font-mono transition-colors cursor-pointer"
                      ...
                      (role === 'qc_analyst' || role === 'qc_manager' || role === 'admin') && (
                        <button
                          ...
                          className="flex items-center gap-1.5 bg-sky-600 hover:bg-sky-700 text-white font-mono font-medium text-xs uppercase px-3.5 py-2 rounded transition-colors border border-sky-500 cursor-pointer shadow-xs"
                        >
                ...
                {selectedReport.decision?.decision === 'reject' && (
                  <div className="rounded border border-red-900/60 bg-red-950/30 p-3.5 font-mono">
                ...
                {resultsSuccess && (
                  <div className="rounded bg-emerald-950/40 p-3 text-xs text-emerald-300 border border-emerald-800/60 flex items-center gap-2 font-mono">
                ...
                <form onSubmit={handleSaveResults} className="space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <span className="rounded bg-[#0d1524] px-2 py-0.5 font-mono text-[10px] text-sky-400 border border-[#23304a] font-medium">
                    ...
                    {(role === 'qc_analyst' || role === 'qc_manager' || role === 'admin') && (
                      <div className="flex flex-wrap items-center gap-1.5">
                        <button
                          ...
                          className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#0d1524] hover:bg-[#182238] text-slate-300 hover:text-white border border-[#23304a] transition-colors cursor-pointer"
                        ...
                        <button
                          ...
                          className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#0d1524] hover:bg-[#182238] text-slate-400 border border-[#23304a] transition-colors cursor-pointer"
                        >
                          Untick All
                        </button>
                      </div>
                  ...
                  <div className="rounded border border-[#23304a] bg-[#0d1524] overflow-hidden">
                    <table className="w-full text-left text-xs">
                      <thead className="bg-[#090e17] text-slate-400 font-mono text-[10px] uppercase tracking-wider border-b border-[#23304a]">
                        <tr>
                      ...
                      <tbody className="divide-y divide-[#1b263b] font-mono text-xs">
                            ...
                            >
                              <td className="py-2 px-3 text-center">
                                <input
                                  ...
                                  disabled={!canEdit}
                                  className="h-3.5 w-3.5 rounded border-[#23304a] bg-[#131b2e] text-sky-600 focus:ring-sky-500 cursor-pointer disabled:opacity-50"
                                  title={isUnticked ? "Unticked: Test not applicable" : "Ticked: Active parameter"}
                                />
                              </td>
                              <td className={`py-2 px-3 font-sans ${isUnticked ? 'text-slate-500' : 'text-slate-200 font-medium'}`}>
                                {res.parameter_name}
                              </td>
                              <td className={`py-2 px-3 ${isUnticked ? 'text-slate-500' : 'text-slate-400'}`}>
                                {res.unit || '-'}
                              </td>
                              <td className="py-2 px-3">
                                {isUnticked ? (
                                  <input
                                    ...
                                    disabled
                                    value="N/A - Unticked"
                                    className="w-full bg-[#090e17] border border-[#1b263b] rounded px-2 py-1 text-xs text-slate-500 cursor-not-allowed font-mono italic"
                                  />
                                  ...
                                  <select
                                    ...
                                    className="w-full bg-[#131b2e] border border-[#23304a] rounded px-2 py-1 text-xs text-slate-100 focus:border-sky-500 disabled:opacity-50 font-mono shadow-xs"
                                  >
                                    <option value="bland" className="bg-[#0c121e] text-slate-100">Bland (Normal)</option>
                                    <option value="acceptable" className="bg-[#0c121e] text-slate-100">Acceptable</option>
                                    <option value="off" className="bg-[#0c121e] text-slate-100">Off / Burnt Odour</option>
                                  </select>
                                ) : (
                                  <input
                                    type="number"
                                    ...
                                    className="w-full bg-[#131b2e] border border-[#23304a] rounded px-2 py-1 text-xs text-slate-100 focus:border-sky-500 focus:ring-1 focus:ring-sky-500/30 disabled:opacity-50 font-mono shadow-xs"
                                  />
                                )}
                              </td>
                            </tr>
                        ...
                        {tempResults.length > 0 && (
                          <tr className={`border-t border-[#23304a] transition-colors ${
                            !isTempAnyTicked
                              ? 'bg-[#090e17] opacity-60'
                              : 'bg-[#131b2e]'
                          }`}>
                            <td className="py-2 px-3 text-center">
                              <input
                                ...
                                className="h-3.5 w-3.5 rounded border-[#23304a] bg-[#0d1524] text-sky-600 focus:ring-sky-500 cursor-pointer disabled:opacity-50"
                                title={isTempAllTicked ? "Untick all 9 temperatures" : "Tick all 9 temperatures"}
                              />
                            </td>
                            <td className="py-2 px-3">
                              <div className="flex flex-wrap items-center gap-2">
                                <span className={`font-semibold font-sans ${isTempAnyTicked ? 'text-slate-100' : 'text-slate-500'}`}>
                                  Temperature
                                </span>
                                <span className="text-[9px] font-mono px-1.5 py-0.2 rounded bg-[#0d1524] text-sky-400 border border-[#23304a] font-medium">
                                ...
                                {(role === 'qc_analyst' || role === 'qc_manager' || role === 'admin') && (
                                  <div className="flex items-center gap-1">
                                    <button
                                      ...
                                      className="text-[9px] font-mono px-1.5 py-0.2 rounded bg-[#0d1524] hover:bg-[#182238] text-slate-300 hover:text-white border border-[#23304a] transition-colors cursor-pointer"
                                    >
                                      All
                                    </button>
                                    <button
                                      ...
                                      className="text-[9px] font-mono px-1.5 py-0.2 rounded bg-[#0d1524] hover:bg-[#182238] text-slate-500 border border-[#23304a] transition-colors cursor-pointer"
                                    >
                                      Clear
                                    </button>
                                  </div>
                          ...
                          return (
                            <tr
                              ...
                              className={`transition-colors border-l-2 ${
                                isUnticked
                                  ? 'opacity-40 bg-[#090e17] border-l-[#1b263b]'
                                  : 'hover:bg-[#131b2e] border-l-sky-500 bg-[#0e1626]'
                              }`}
                            >
                              <td className="py-2 px-3 text-center">
                                <input
                              ...
                              <td className="py-2 px-3 font-sans">
                                <div className="flex items-center gap-2 pl-3">
                                  ...
                                  <span className="text-[9px] font-mono text-slate-400 bg-[#0d1524] px-1 rounded border border-[#23304a]">
                                    Pt {res.series_key}
                                  </span>
                                </div>
                              </td>
                  ...
                  <div className="rounded border border-[#23304a] bg-[#0d1524] p-4 space-y-3">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#23304a] pb-2">
                      <div className="flex items-center gap-2">
                        <FileText className="h-3.5 w-3.5 text-sky-400" />
                        <span className="text-[10px] font-bold uppercase tracking-wider text-slate-300 font-mono">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <label className={`flex items-start gap-2.5 p-2.5 rounded border transition-colors cursor-pointer select-none ${
                        qcRemarkFlushing 
                          ? 'bg-amber-950/30 border-amber-900/60 text-amber-200' 
                          : 'bg-[#131b2e] border-[#23304a] text-slate-300 hover:border-slate-600'
                      }`}>
                        <input
                          type="checkbox"
                          disabled={!canEdit}
                          ...
                          className="mt-0.5 h-3.5 w-3.5 rounded border-[#23304a] bg-[#0d1524] text-amber-500 focus:ring-amber-500 cursor-pointer"
                        />
                      ...
                      <label className={`flex items-start gap-2.5 p-2.5 rounded border transition-colors cursor-pointer select-none ${
                        ...
                        <input
                          ...
                          className="mt-0.5 h-3.5 w-3.5 rounded border-[#23304a] bg-[#0d1524] text-sky-600 focus:ring-sky-500 cursor-pointer"
                        />
                        <div className="font-mono text-xs">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full bg-[#131b2e] border border-[#23304a] rounded px-3 py-2 text-xs font-mono text-slate-100 placeholder-slate-500 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500/30 disabled:opacity-50 resize-none shadow-xs"
                      />
                    </div>
                  </div>
              ...
              <div className="rounded-lg border border-[#23304a] bg-[#131b2e] p-12 text-center text-slate-500 text-xs font-mono">
      ...
      {isDecisionModalOpen && selectedReport && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
          <div className="w-full max-w-lg rounded-lg border border-[#23304a] bg-[#131b2e] p-6 shadow-2xl space-y-4">
            <div className="flex items-center gap-3 text-sky-400 border-b border-[#23304a] pb-3">
            ...
            {decisionError && (
              <div className="rounded bg-red-950/40 p-2.5 text-xs text-red-300 border border-red-800/60 font-mono">
                {decisionError}
              </div>
            )}
            ...
            <form onSubmit={handleSubmitDecision} className="space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  <button
                    ...
                    className={`py-2 px-3 rounded border text-xs font-mono font-medium transition-colors cursor-pointer ${
                      decisionType === 'accept'
                        ? 'bg-emerald-950/50 border-emerald-500 text-emerald-300 shadow-xs'
                        : 'border-[#23304a] bg-[#0d1524] text-slate-400 hover:text-slate-200'
                    }`}
                  >
                    ACCEPT
                  </button>
                  ...
                  <button
                    ...
                    className={`py-2 px-3 rounded border text-xs font-mono font-medium transition-colors cursor-pointer ${
                      decisionType === 'accept_concession'
                        ? 'bg-amber-950/50 border-amber-500 text-amber-300 shadow-xs'
                        : 'border-[#23304a] bg-[#0d1524] text-slate-400 hover:text-slate-200'
                    }`}
                  >
                    CONCESSION
                  ...
                  <button
                    ...
                    className={`py-2 px-3 rounded border text-xs font-mono font-medium transition-colors cursor-pointer ${
                      decisionType === 'reject'
                        ? 'bg-red-950/50 border-red-500 text-red-300 shadow-xs'
                        : 'border-[#23304a] bg-[#0d1524] text-slate-400 hover:text-slate-200'
                    }`}
                  >
                    REJECT
                ...
                <>
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-[#0d1524] border border-[#23304a] rounded px-3 py-1.5 text-xs font-mono text-slate-100 cursor-pointer focus:border-sky-500 focus:ring-1 focus:ring-sky-500/30"
                    >
                      <option value="" className="bg-[#0c121e] text-slate-100">-- Choose Reason Code --</option>
                      {reasons.map(r => (
                        <option key={r.id} value={r.id} className="bg-[#0c121e] text-slate-100">{r.label}</option>
                      ))}
                    </select>
                  </div>
                  ...
                  {decisionType === 'reject' && (
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-[#0d1524] border border-[#23304a] rounded px-3 py-1.5 text-xs font-mono text-amber-400 font-medium cursor-pointer focus:border-sky-500 focus:ring-1 focus:ring-sky-500/30"
                      >
                        <option value="reprocess" className="bg-[#0c121e] text-slate-100">Reprocess (Return to Deodorizer)</option>
                        <option value="rework" className="bg-[#0c121e] text-slate-100">Rework (Bleaching/Pre-treatment)</option>
                        <option value="downgrade" className="bg-[#0c121e] text-slate-100">Downgrade to Lower Grade Product</option>
                        <option value="hold" className="bg-[#0c121e] text-slate-100">Quality Hold (Quarantine Tank)</option>
                        <option value="scrap" className="bg-[#0c121e] text-slate-100">Scrap / By-product Tank</option>
                      </select>
                    </div>
                  )}
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#0d1524] border border-[#23304a] rounded px-3 py-1.5 text-xs font-mono text-slate-100 placeholder-slate-500 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500/30 resize-none"
                    />
                  </div>
                </>
              )}
              ...
              <div className="border-t border-[#23304a] pt-3">
                <label className="block text-[11px] font-mono text-slate-300 mb-1">
                ...
                <input
                  ...
                  className="w-full bg-[#0d1524] border border-[#23304a] rounded px-3 py-1.5 text-xs font-mono text-slate-100 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500/30"
                />
              </div>
